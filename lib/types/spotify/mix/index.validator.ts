...
import Ajv from 'ajv';
import SpotifyMixType from './index';
export const ajv = new Ajv({"allErrors":true,"coerceTypes":false,"format":"fast","nullable":true,"unicode":true,"uniqueItems":true,"useDefaults":true});

ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-06.json'));

export {SpotifyMixType};
export const SpotifyMixTypeSchema = {
...
export const isSpotifyMixType = ajv.compile(SpotifyMixTypeSchema) as ValidateFunction<SpotifyMixType>;
export default function validate(value: unknown): SpotifyMixType {
  if (isSpotifyMixType(value)) {
    return value;
  } else {
    throw new Error(
      ajv.errorsText(isSpotifyMixType.errors!.filter((e: any) => e.keyword !== 'if'), {dataVar: 'SpotifyMixType'}) +
      '\n\n' +
      inspect(value),
    );
  }
